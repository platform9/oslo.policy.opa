package create_port.allowed_address_pairs
...
#"create_port:allowed_address_pairs": "(rule:admin_only) or (role:member and rule:network_owner) or role:manager and project_id:%(project_id)s or rule:service_api"
